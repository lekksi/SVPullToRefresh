Pod::Spec.new do |s|
  ...
  s.author   = { 'Sam Vermette' => 'hello@samvermette.com', 'Aleksi Hoffman' => 'open_source@lekksi.com' }
  s.source   = { :git => 'https://github.com/lekksi/SVPullToRefresh.git', :tag => s.version.to_s }
